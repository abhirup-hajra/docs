...
3. **Power:** Use propietory models including ones developed by FlintAI, and various open-source LLMs having upto 1 trillion parameters.
4. **Multiple Models:** Access to various models from cheap, lightweight ones to heavyduty LLMs. Check https://flintstudios.mintlify.app/flintai/models for all models.
